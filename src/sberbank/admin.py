...
class PaymentAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        (_("More details"), {"classes": ("collapse",), "fields": ["details", "error_code", "error_message"]}),
    )
...
class LogEntryAdmin(admin.ModelAdmin):
    ...
    readonly_fields = ("created", "uid", "payment_id", "bank_id", "action", "request_text", "response_text", "checksum")
