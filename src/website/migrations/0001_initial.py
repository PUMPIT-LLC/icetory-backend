    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "entrance",
                    models.PositiveSmallIntegerField(blank=True, default=None, null=True, verbose_name="Подъезд"),
                ),
                ...
                (
                    ...
                    models.SmallIntegerField(
                        choices=[(-1, "Спам"), (0, "Создан"), (10, "Взят в работу"), (20, "Готов")], default=0
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "title",
                    models.CharField(blank=True, default="", max_length=120, verbose_name="Символическое название"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "portion_unit",
                    models.CharField(default="г.", max_length=10, verbose_name="Единица измерения порции"),
                ),
                (
                    "extra_picture",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="extra_picture",
                        to="website.productimage",
                    ),
                ),
                (
                    "main_picture",
                ...
                (
                    ...
                    models.ManyToManyField(
                        ...
                        to="website.Category",
                        verbose_name="Второстепенные категории",
                    ),
                ),
            ],
            options={
